...
const Form = () => {
    ...
    return (
        <Box sx={{ background: "#FFFFFF", borderRadius: 5, padding: "5vw", width: "75%", margin: "auto" }}>
            <Typography
                variant="h4"
                sx={{ fontSize: "1.3em", textAlign: "left", marginTop: "vw", fontFamily: "Russo One", marginLeft: "4px", lineHeight: "1.3" }}
            >
                Нужен такой формат - просто скажите: обсудим, разработаем, проведём
            </Typography>
            <Typography sx={{ fontSize: "10.5pt", marginTop: "1em", lineHeight: 1.5, fontFamily: "Roboto", marginLeft: "4px" }}>
